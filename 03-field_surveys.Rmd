...
This chapter illustrates procedures for organizing and conducting field surveys as well as for collecting physical samples. This is the practical, field-based side-of-things, which provides field observations and physical measurements of rock, water, soil, plant and potentially livestock fecal (and/or blood) samples, which can be georeferenced, measured, assembled and databased in a consistent manner. 

Field survey activities are fairly expensive to implement but also but also have particulary high information value for any subsequent analyses and management decisions. So, it is very important to plan and execute the associated field activities carefully. We can think of field surveys, monitoring and/or experiments as occurring in 6 sequential steps:
...
1. Finally, repeat and update the previous 5 steps over time.

The associated activities have to be carried out in sequence; but, the actual procedures can certainly be changed as different survey or monitoring priorities emerge. This chapter covers the 6 needed steps, including example data, R-code and the relevant links to external open-source resources.
