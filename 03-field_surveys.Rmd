...
The associated activities essentially have to be carried out in sequence, but the actual procedures can be adjusted or changed over time as different monitoring priorities emerge. This chapter covers those 5 needed steps, including example data, R-code and relevant links.
