...
This chapter illustrates procedures for organizing and conducting field surveys and sample collections. This is the practical side-of-things, which gets field observations and physical (rock, soil, plant and potentially livestock biomarker) samples assembled in a consistent manner, which can be analyzed. Because field survey activities are expensive, but also of particulary high value to any subsequent analyses it is very important to plan and execute these carefully. 
