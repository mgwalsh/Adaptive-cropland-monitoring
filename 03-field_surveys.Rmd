---
title: "Field surveys and physical sample collections"
author: M. G. Walsh
date: "21/11/2020"
...
The associated activities should to be carried out in sequence. But, the actual procedures can certainly be changed as different survey or monitoring priorities emerge over time. This chapter covers the 6 steps including example data, R-code and the relevant links to external open-source resources.
...
The data for running the Rwanda example are accessible via the following chunk:

```{r}
# Data setup --------------------------------------------------------------
# download & stack cropland probability/mask & distance to distance to buildings grids
...
bd <- 2.5  ## set maximum sampling distance to the nearest "buildings" (in km)
