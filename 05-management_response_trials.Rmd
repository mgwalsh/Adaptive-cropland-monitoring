...
The most reliable and informative way of monitoring both the current situation and the potentials is by using [**Randomized Controlled Trials**](https://en.wikipedia.org/wiki/Randomized_controlled_trial) (RCT). However, the main problems with all RCTs is that they are usually logistically difficult and quite expensive to conduct.

... agricultural development projects carry out regular monitoring and evaluation surveys to gauge impacts or to adjust management interventions where needed. More generally, these are known as [**Observational Surveys**](https://en.wikipedia.org/wiki/Observational_study) that can be applied in various configurations. Although observational surveys cannot be used to make definitive statements of fact about the "effectiveness" of a management practice, they are used to:
