...
The main reason for gathering GeoSurvey observations is is that these allow us to rapidly assess where in a particular country significant impacts of humans on ecosystem processess can be expected. We have frequently been able to provide highly accurate assessments and maps of where anthropic impacts are like to occur  in remote places that are often not reachable by car.
...
The overall workflow shown in Fig. fig:\@ref(GS_workflow) is implemented in four main steps:
