...
This chunk then just identifies users whose agreement rates are in <50% agreement with the experts and dumps their data.
...
If you've run the previous code chunks, the data should be in memory and can be accessed with the following.
